...
var mediansorted = require( './../lib/main.js' );
...
tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( mediansorted.length, 1, 'returns expected value' );
	t.end();
});
...
tape( 'the function calculates the median value of a sorted array', function test( t ) {
	var x;
	var v;
...
tape( 'the function calculates the median value of a sorted array (accessors)', function test( t ) {
	var x;
	var v;

	x = [ -3.0, -2.0, -1.0, 1.0, 2.0, 3.0 ];
	v = mediansorted( toAccessorArray( x ) );
	t.strictEqual( v, 0.0, 'returns expected value' );
...
tape( 'the function calculates the median value of a sorted array (array-like object)', function test( t ) {
	var x;
	var v;
...
tape( 'if provided an array containing a single element, the function returns the first element (accessors)', function test( t ) {
	var v = mediansorted( toAccessorArray( [ 1.0 ] ) );
	t.strictEqual( v, 1.0, 'returns expected value' );
	t.end();
});
